...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7536786020:AAF_WpOJdPOGNX9c2tyHUmeUqBDYuZwzjd8")
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://AnimeRavenBots:AnimeRavenBots@animeravenbots.huekk.mongodb.net/?retryWrites=true&w=majority&appName=MioSaimoriFileBot")
DB_NAME = os.environ.get("DATABASE_NAME", "MioSaimoriFileBot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://envs.sh/HMj.jpg")).split() #Required
